<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="安保详情" prop="anbaoxiangqing">
          <el-input v-model="ruleForm.anbaoxiangqing" 
              placeholder="安保详情" clearable  :readonly="ro.anbaoxiangqing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="安保详情" prop="anbaoxiangqing">
              <el-input v-model="ruleForm.anbaoxiangqing" 
                placeholder="安保详情" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="取消安保时间" prop="quxiaoanbaoshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.quxiaoanbaoshijian" 
                type="datetime"
                placeholder="取消安保时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.quxiaoanbaoshijian" label="取消安保时间" prop="quxiaoanbaoshijian">
              <el-input v-model="ruleForm.quxiaoanbaoshijian" 
                placeholder="取消安保时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  data() {
	...
	shouji : false,
	fangwudizhi : false,
	anbaoxiangqing : false,
	yuyueshijian : false,
	quxiaoanbaoshijian : false,
	quxiaoyuanyin : false,
	sfsh : false,
	shhf : false,
      },
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fangwudizhi = true;
          ...
          if(o=='anbaoxiangqing'){
            this.ruleForm.anbaoxiangqing = obj[o];
	    this.ro.anbaoxiangqing = true;
            continue;
          }
          if(o=='yuyueshijian'){
	    ...
	    this.ro.yuyueshijian = true;
          ...
          if(o=='quxiaoanbaoshijian'){
            this.ruleForm.quxiaoanbaoshijian = obj[o];
	    this.ro.quxiaoanbaoshijian = true;
            continue;
          }
          if(o=='quxiaoyuanyin'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `anbaoquxiaoguanli/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.anbaoquxiaoguanliCrossAddOrUpdateFlag = false;
                  this.parent.search();
