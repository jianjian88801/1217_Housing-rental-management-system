<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="保洁详情" prop="baojiexiangqing">
          <el-input v-model="ruleForm.baojiexiangqing" 
              placeholder="保洁详情" clearable  :readonly="ro.baojiexiangqing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="保洁详情" prop="baojiexiangqing">
              <el-input v-model="ruleForm.baojiexiangqing" 
                placeholder="保洁详情" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="取消保洁时间" prop="quxiaobaojieshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.quxiaobaojieshijian" 
                type="datetime"
                placeholder="取消保洁时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.quxiaobaojieshijian" label="取消保洁时间" prop="quxiaobaojieshijian">
              <el-input v-model="ruleForm.quxiaobaojieshijian" 
                placeholder="取消保洁时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  data() {
	...
	shouji : false,
	fangwudizhi : false,
	baojiexiangqing : false,
	yuyueshijian : false,
	quxiaobaojieshijian : false,
	quxiaoyuanyin : false,
	sfsh : false,
	shhf : false,
      },
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fangwudizhi = true;
          ...
          if(o=='baojiexiangqing'){
            this.ruleForm.baojiexiangqing = obj[o];
	    this.ro.baojiexiangqing = true;
            continue;
          }
          if(o=='yuyueshijian'){
	    ...
	    this.ro.yuyueshijian = true;
          ...
          if(o=='quxiaobaojieshijian'){
            this.ruleForm.quxiaobaojieshijian = obj[o];
	    this.ro.quxiaobaojieshijian = true;
            continue;
          }
          if(o=='quxiaoyuanyin'){
    ...
    info(id) {
      this.$http({
        url: `baojiequxiaoguanli/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `baojiequxiaoguanli/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.baojiequxiaoguanliCrossAddOrUpdateFlag = false;
                  this.parent.search();
