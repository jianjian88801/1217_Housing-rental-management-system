<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="用房日期" prop="yongfangriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.yongfangriqi" 
                type="date"
                placeholder="用房日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.yongfangriqi" label="用房日期" prop="yongfangriqi">
              <el-input v-model="ruleForm.yongfangriqi" 
                placeholder="用房日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="还房日期" prop="haifangriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.haifangriqi" 
                type="date"
                placeholder="还房日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.haifangriqi" label="还房日期" prop="haifangriqi">
              <el-input v-model="ruleForm.haifangriqi" 
                placeholder="还房日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="租用天数" prop="zuyongtianshu">
          <el-input v-model="ruleForm.zuyongtianshu" 
              placeholder="租用天数" clearable  :readonly="ro.zuyongtianshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="租用天数" prop="zuyongtianshu">
              <el-input v-model="ruleForm.zuyongtianshu" 
                placeholder="租用天数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  computed: {
    zongjine:{
      get: function () {
        return 1*this.ruleForm.fangjianshu*this.ruleForm.meitianjiage*this.ruleForm.zuyongtianshu
      }
    },
  },
  created() {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fangwutupian = true;
          ...
          if(o=='yongfangriqi'){
            this.ruleForm.yongfangriqi = obj[o];
	    this.ro.yongfangriqi = true;
            continue;
          }
          if(o=='haifangriqi'){
            this.ruleForm.haifangriqi = obj[o];
	    this.ro.haifangriqi = true;
            continue;
          }
          if(o=='fangjianshu'){
	    ...
	    this.ro.meitianjiage = true;
          ...
          if(o=='zuyongtianshu'){
            this.ruleForm.zuyongtianshu = obj[o];
	    this.ro.zuyongtianshu = true;
            continue;
          }
          if(o=='zongjine'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `zuyongdingdan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zuyongdingdanCrossAddOrUpdateFlag = false;
                  this.parent.search();
